...
const links = [
  ...
  { href: '/dashboard/access', label: 'Control de Acceso' },
  { href: '/dashboard/documents', label: 'Doc. Genérica' },
...
export default function Sidebar() {
  ...
  return (
    <aside className="sticky top-0 h-screen w-64 bg-brandNeutralDark text-brandNeutralLight p-6 flex flex-col">
      <h2 className="text-2xl font-semibold  mb-8 select-none">Plataforma CAE</h2>
